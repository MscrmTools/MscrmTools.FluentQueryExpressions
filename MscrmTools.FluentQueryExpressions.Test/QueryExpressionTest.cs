    ...
    public class QueryExpressionTest
    {
        ...
        public void ShouldSetWhere()
        {
            ...
            var query2 = new Query<Account>()
                .Where(Account.EntityLogicalName, Account.Fields.AccountId, ConditionOperator.Above, guid);
        ...
        public void ShouldSetWhereBetween()
        {
            ...
            var query2 = new Query<Account>()
                .WhereBetween(Account.Fields.NumberOfEmployees, 10, 50, Account.EntityLogicalName);
        ...
        {
            var query = new Query<Account>()
                .WhereContainValues(Account.Fields.CustomerTypeCode, 1, 2, 3);
            ...
            var query2 = new Query<Account>()
                .WhereContainValues(Account.EntityLogicalName, Account.Fields.CustomerTypeCode, 1, 2, 3);
        ...
        {
            var query = new Query<Account>()
                .WhereDoesNotContainValues(Account.Fields.CustomerTypeCode, 1, 2, 3);
            ...
            var query2 = new Query<Account>()
                .WhereDoesNotContainValues(Account.EntityLogicalName, Account.Fields.CustomerTypeCode, 1, 2, 3);
        ...
        {
            var query = new Query<Account>()
                .WhereIn(Account.Fields.CustomerTypeCode, 1, 2, 3);
            ...
            var query2 = new Query<Account>()
                .WhereIn(Account.EntityLogicalName, Account.Fields.CustomerTypeCode, 1, 2, 3);
        ...
        public void ShouldSetWhereInOrAfterFiscalPeriodAndYear()
        {
            ...
            var query2 = new Query<Account>()
                .WhereInOrAfterFiscalPeriodAndYear(Account.Fields.CreatedOn, 1, 2018, Account.EntityLogicalName);
        ...
        public void ShouldSetWhereInOrBeforeFiscalPeriodAndYear()
        {
            ...
            var query2 = new Query<Account>()
                .WhereInOrBeforeFiscalPeriodAndYear(Account.Fields.CreatedOn, 1, 2018, Account.EntityLogicalName);
